...
export async function aiRoutes(app) {
    ...
    app.post('/ai/safety', { preHandler: app.authenticate }, async (request, reply) => {
        ...
        const messages = [
            {
                role: 'system',
                content: 'You are a biohacking safety advisor. Analyze protocols for potential interactions, contraindications, and safety concerns. ' +
    ...
    app.post('/ai/protocol-parser', { preHandler: app.authenticate }, async (request, reply) => {
        ...
        const messages = [
            {
                role: 'system',
                content: 'You are a protocol parser for a biohacking app. Extract protocol details from natural language. ' +
